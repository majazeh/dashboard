    ...
    function lijax(context, onFire) {
        ...
        function send() {
            ...
            if ($(context).is('form')) {
                ...
                var data = {};
                if ($(context).attr('enctype') == 'multipart/form-data') {
                    data = Data;
                } else {
            ...
            new Statio({
                ...
                context: context,
                ajax: {
                    contentType: $(context).is('form') && $(context).attr('enctype') == 'multipart/form-data' ? false : 'application/x-www-form-urlencoded; charset=UTF-8',
                    processData: $(context).is('form') && $(context).attr('enctype') == 'multipart/form-data' ? false : true,
                    cache: false,
                    method: method,
                    data: data
                },
