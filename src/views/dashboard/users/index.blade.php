...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            <td><a href="{{ route($module->resource . '.edit', $user->id) }}">{{ $user->id }}</a></td>
            <td>{{ $user->name }}</td>
            <td>{{ $user->username }}</td>
            <td>{{ $user->email }}</td>
            <td>{{ $user->mobile }}</td>
            ...
            <td><i class="fas fa-{{ $user->gender ?: 'genderless' }} {{ $user->gender == 'male' ? 'text-primary' : ($user->gender == 'female' ? 'text-info' : '')}}"></i></td>
            <td>
                <a href="{{ route($module->resource . '.edit', $user->id) }}"><i class="fas fa-edit"></i></a>
            </td>
        </tr>
        @endforeach
    </table>
